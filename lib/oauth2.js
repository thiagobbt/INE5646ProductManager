...
const config = {
  OAUTH2_CLIENT_ID: "166756763834-n15dcsmkngn3u10h1r8lmk9mat57920v.apps.googleusercontent.com",
  OAUTH2_CLIENT_SECRET: process.env.OAUTH2_CLIENT_SECRET,
  OAUTH2_CALLBACK: process.env.OAUTH2_CALLBACK || "http://localhost:5000/auth/google/callback",
  get: function(key) {
    return this[key];
  }
}
